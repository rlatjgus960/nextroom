	...
	<div id="wrap">
		...
		<div id="content" >
			...
			<div id="subheader" class="clearfix">
				...
				<div id="subheader-mintitle">커뮤니티 > 자유게시판 > 수정</div>
				...
				<div id="mypageMain" class="clearfix">
					...
					<div id="list_button" >
						<ul>							
							...
							<a href="${pageContext.request.contextPath }/community/hot"><img src="${pageContext.request.contextPath }/assets/image/board_image/hot.png" width="14px" height="14px" >인 기</a>
							<a href="${pageContext.request.contextPath }/community/Like"><img src="${pageContext.request.contextPath }/assets/image/board_image/hit.png" width="14px" height="14px" >조 회</a>
                    ...
                    <div id="writecontent_area">
						...
						<form id="boardForm" action="freemodify" method="post" enctype="multipart/form-data"> 
							...
							<div id="nick_date">
                             ...
                             <div id="fileUp"> 
                             	<img src="${pageContext.request.contextPath }/upload/${freeBoardVo.boardImg}" style="width: 50px; height:50px;">
                             	<p>이미지 업로드</p> 
