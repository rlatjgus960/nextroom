			...
			<div id="contentMain" class="clearfix">
				...
				<div id="contentWrap">
					...
					<div id="cafeModify" class="">
						<form id="addCafeForm" action="${pageContext.request.contextPath}/mypage/addCafe"
							...
							<div id="cafe_explain_wrap">
								...
								<div id="address_wrap" class="cafe_explain_item clearfix">
									...
									<div class="address_search">
										...
										<input name="sigungu" type="hidden" id="sigungu" placeholder="시군구"> <input
											type="hidden" id="sample5_address" placeholder="주소"> <input type="hidden"
											name="latitude" id="latitude" placeholder="위도" value=""> <input type="hidden"
											name="longitude" id="longitude" placeholder="경도" value="">
							...
							<div id="cafeModify_button">
								<button id="addCafeBtn" type="submit" class="mbutton">신청하기</button>
							</div>
						</form>
...
<script>
	...
	$("#addCafeBtn").on(
			...
			function() {
				...
				if ($("[name='cafeImgFile']").val() == ''
						|| $("[name='cafeImgFile']").val() == null) {

					alert("메인이미지를 첨부해 주세요");
					event.preventDefault();
					return flase;
				} else if ($("[name='interiorImg']").val() == ''
						|| $("[name='interiorImg']").val() == null) {

					alert("내부이미지를 한개 이상 첨부해 주세요");
					event.preventDefault();
					return flase;
				} else if ($("[name='cafeName']").val() == ''
